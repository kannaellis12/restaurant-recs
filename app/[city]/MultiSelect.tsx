  ...
  return (
    <div ref={wrapperRef} className="relative">
      <button
        ...
        aria-expanded={open}
        className={[
          "font-mono text-mono-sm uppercase tracking-wider border bg-paper pl-2 pr-1.5 h-7 text-ink cursor-pointer hover:border-ink focus:outline-none focus:border-ink inline-flex items-center gap-1.5",
